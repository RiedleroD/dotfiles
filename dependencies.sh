...
kvantum-qt5 kvantum-theme-arc arc-gtk-theme papirus-icon-theme pipewire \
pipewire-pulse pipewire-jack-dropin pipewire-alsa pipewire-v4l2 \
pipewire-media-session helvum gst-plugin-pipewire --needed
